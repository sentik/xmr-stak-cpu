...
void blake256_update64(state *S, const u8 *data, u64 datalen) {
...
void blake256_update8(state *S, const u8 *data, u64 datalen) 
{
...
void blake256_final(state *S, u8 *digest) {
	...
	blake256_update8(S, &zo, 8);

	S->t[0] -= 72;
	blake256_update64(S, msglen, 64);
