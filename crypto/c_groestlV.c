...
static void RND512PV(uint8_t *x, uint32_t *y, uint32_t r) {
...
static void RND512QV(uint8_t *x, uint32_t *y, uint32_t r) {
  uint32_t temp_v1, temp_v2, temp_upper_value, temp_lower_value, temp;
  uint32_t* x32 = (uint32_t*)x;
  x32[ 0] = ~x32[ 0];
  x32[ 1] ^= 0xffffffff^r;
...
static void F512V(uint32_t *h, const uint32_t *m) {
  int i;
  ...
  /* compute Q(m) */
  RND512QV((uint8_t*)z, y, 0x00000000);
  RND512QV((uint8_t*)y, z, 0x01000000);
  RND512QV((uint8_t*)z, y, 0x02000000);
  RND512QV((uint8_t*)y, z, 0x03000000);
  RND512QV((uint8_t*)z, y, 0x04000000);
  RND512QV((uint8_t*)y, z, 0x05000000);
  RND512QV((uint8_t*)z, y, 0x06000000);
  RND512QV((uint8_t*)y, z, 0x07000000);
  RND512QV((uint8_t*)z, y, 0x08000000);
  RND512QV((uint8_t*)y, Qtmp, 0x09000000);

  /* compute P(h+m) */
  RND512PV((uint8_t*)Ptmp, y, 0x00000000);
  RND512PV((uint8_t*)y, z, 0x00000001);
  RND512PV((uint8_t*)z, y, 0x00000002);
  RND512PV((uint8_t*)y, z, 0x00000003);
  RND512PV((uint8_t*)z, y, 0x00000004);
  RND512PV((uint8_t*)y, z, 0x00000005);
  RND512PV((uint8_t*)z, y, 0x00000006);
  RND512PV((uint8_t*)y, z, 0x00000007);
  RND512PV((uint8_t*)z, y, 0x00000008);
  RND512PV((uint8_t*)y, Ptmp, 0x00000009);
...
static void TransformV(groestlHashState *ctx,
	       const uint8_t *input, 
	       int msglen) {
  ...
  for (; msglen >= SIZE512; 
	...
	F512V(ctx->chaining,(uint32_t*)input);
...
static void OutputTransformationV(groestlHashState *ctx) {
  int j;
  ...
  uint32_t z[2*COLS512];
	...
	RND512PV((uint8_t*)temp, y, 0x00000000);
	RND512PV((uint8_t*)y, z, 0x00000001);
	RND512PV((uint8_t*)z, y, 0x00000002);
	RND512PV((uint8_t*)y, z, 0x00000003);
	RND512PV((uint8_t*)z, y, 0x00000004);
	...
	RND512PV((uint8_t*)y, z, 0x00000007);
	RND512PV((uint8_t*)z, y, 0x00000008);
	RND512PV((uint8_t*)y, temp, 0x00000009);
	for (j = 0; j < 2*COLS512; j++) {
...
/* initialise context */
static void InitV(groestlHashState* ctx) {
  int i = 0;
...
static void UpdateV(groestlHashState* ctx,
  ...
  if (ctx->buf_ptr) {
	...
	/* digest buffer */
	ctx->buf_ptr = 0;
	TransformV(ctx, ctx->buffer, SIZE512);
  }

  /* digest bulk of message */
  TransformV(ctx, input+index, msglen-index);
...
static void FinalV(groestlHashState* ctx,
		 BitSequence* output) {
...
/* hash bit sequence */
void groestlV(const BitSequence* data, 
		DataLength databitlen,
		BitSequence* hashval) {
  ...
  /* process message */
  UpdateV(&context, data, databitlen);

  /* finalise */
  FinalV(&context, hashval);
}
/*
