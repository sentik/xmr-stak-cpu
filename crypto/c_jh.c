...
void Init(hashState *state, int hashbitlen)
{
	...
	state->x0 = LOAD(JH_H0);
	state->x1 = LOAD(JH_H0 + 16);
	state->x2 = LOAD(JH_H0 + 32);
	state->x3 = LOAD(JH_H0 + 48);
	state->x4 = LOAD(JH_H0 + 64);
	state->x5 = LOAD(JH_H0 + 80);
	state->x6 = LOAD(JH_H0 + 96);
	state->x7 = LOAD(JH_H0 + 112);
}

/*hash each 512-bit message block, except the last partial block*/
void Update(hashState *state, const BitSequence *data, DataLength databitlen)
{
	DataLength i;
